...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
  ...
  #  result.geometry('700x550')
    ...
    Label(result, text="Result - Personality Prediction", foreground='#27AE60', bg='white', font=titleFont, pady=10, anchor=CENTER).pack(fill=BOTH)
    ...
    titleFont1 = font.Font(family='Arial', size=16, weight='bold')
    Label(result, text = str("Predicted personality: "+personality).title(),font=titleFont1, foreground='#138D75', bg='white', anchor='w').pack(fill=BOTH)
    
    quitBtn = Button(result, text="Exit",bg="#A93226",foreground='white',command =lambda:  result.destroy()).pack()
...
def perdict_person():
    ...
    lab=Label(top, text="Personality Prediction", foreground='#CD5C5C', bg='black', font=titleFont, pady=10).pack()
    ...
    l6=Label(top, text="Wishing to do one's work well and thoroughly (Conscientiousness)", foreground='white', bg='black').place(x=70, y=280)
    l7=Label(top, text="How outgoing and social interaction you like (Extraversion)", foreground='white', bg='black').place(x=70, y=310)
    l8=Label(top, text="How much would you like work with your peers (Agreeableness)", foreground='white', bg='black').place(x=70, y=340)
    l9=Label(top, text="How Often You Feel Negativity (Neuroticism)", foreground='white', bg='black').place(x=70, y=370)
    ...
    submitBtn=Button(top, padx=2, pady=0, text="Submit", bd=0, foreground='white', bg='#2ECC71', font=(12))
...
if __name__ == "__main__":
    ...
    lab=Label(root, text="Personality Prediction System", bg='#FFA07A',foreground='white',font=titleFont, pady=30).pack()
